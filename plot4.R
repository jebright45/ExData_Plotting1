...
par(mfrow = c(2,2))
plot(x = subhousedata3$DateTime, y = subhousedata3$Global_active_power, type = "n", xlab = "", ylab = "Global Active Power" )
# type = "n" tells R to make the plot but not to put in the data yet
lines(x = subhousedata3$DateTime, y = subhousedata3$Global_active_power)
plot(x = subhousedata3$DateTime, y = subhousedata3$Voltage, type = "n", xlab = "datetime", ylab = "Voltage")
lines(x = subhousedata3$DateTime, y = subhousedata3$Voltage)
...
plot(x = subhousedata3$DateTime, y = subhousedata3$Global_reactive_power, xlab = "datetime", ylab = "Global_reactive_power", type = "n")
lines(x = subhousedata3$DateTime, y = subhousedata3$Global_reactive_power)



# --- CREATING FOURTH PLOT PNG ---------------------------------------------------
